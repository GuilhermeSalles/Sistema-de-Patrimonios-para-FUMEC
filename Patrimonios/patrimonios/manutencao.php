                ...
                <div class="modal-body">
                    ...
                    <form method="POST" action="editaManutencao.php" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="recipient-equipamento" name="equipamento"readonly>
                        </div>

                        <div class="form-group">
                            <label for="recipient-patrimonio" class="col-form-label bold">Número de Patrimônio:</label>
                            <input type="text" class="form-control" id="recipient-patrimonio" autocomplete="off" name="patrimonio"readonly>
                        </div>

                        <div class="form-group">
                            <label for="recipient-serie" class="col-form-label bold">Número de séries:</label>
                            <input type="text" class="form-control" id="recipient-serie" autocomplete="off" name="serie"readonly>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="recipient-unidade" name="unidade"readonly>
                        </div>

                        <div class="form-group">
                            <label for="recipient-setor" class="col-form-label bold">Setor:</label>
                            <input type="text" class="form-control" id="recipient-setor" name="setor"readonly>
                        </div>

                        <div class="form-group">
                            <label for="recipient-coordenada" class="col-form-label bold">Coordenadas:</label>
                            <input type="text" class="form-control" id="recipient-coordenada" autocomplete="off" name="coordenada"readonly>
                        </div>

                        <div class="form-group">
                            <label for="recipient-usuario" class="col-form-label bold">Usuário:</label>
                            <input type="text" class="form-control" id="recipient-usuario" name="usuario"readonly>
                        </div>
                        ...
                        <div class="form-group" alt="Se corrigiu o problema digite: Funcionando">
                            ...
                            <small id="emailHelp" class="form-text text-muted">Se corrigiu o problema digite: Funcionando</small>
                        </div>
