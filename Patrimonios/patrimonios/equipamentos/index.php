...
$result_equipamentos = "SELECT * FROM equipamento order by id ";
$result = mysqli_query($conexao, $result_equipamentos);
...
<body>
    ...
    <div class="container">
        ...
        <div class="text-center">
            <h4 class="bold">Lista de Equipamentos</h4>
            <hr class="hr3">
        </div>
        <div class="row">
            <div class="ml-3">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title bold " id="cadastrarLabel" style="margin-left: 100px;">Cadastro Equipamentos</h5>
                            ...
                            <div class="modal-body">
                                <form method="POST" action="processa.php" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label for="recipient-Nome" class="col-form-label bold">Nome equipamento:</label>
