...
$result_usuario = "SELECT * FROM usuario_equipamento order by id ";
...
<body>
    ...
    <div class="container">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title bold " id="cadastrarLabel" style="margin-left: 100px;">Cadastro usuários</h5>
                            ...
                            <div class="modal-body">
                                <form method="POST" action="processa.php" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label for="recipient-Nome" class="col-form-label bold">Nome da usuários:</label>
        ...
        <table class="table table-hover">
            <thead>
                <tr>
                    <th class="text-center">Nome da usuários</th>
