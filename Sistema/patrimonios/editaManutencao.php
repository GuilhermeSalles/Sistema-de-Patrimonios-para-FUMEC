...
$sql = "UPDATE patrimonio SET equipamento='$equipamento', patrimonio='$patrimonio' ,serie='$serie' ,unidade='$unidade' ,setor='$setor' , coordenada='$coordenada' ,usuario='$usuario' ,manutencao='$manutencao' WHERE id = $id ";
