...
<head>
    ...
    <title>FUMEC - SISTEMA DE PATRIMÔNIOS</title>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-8 d-lg-block d-none mt-4">
                <h1 style="color: #fe5522a8; font-weight: bolder;" class="text-center display-2">PATRIMÔNIOS</h1>
            </div>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSite">
                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <?php if ($_SESSION['nivel'] == "Administrativo" or $_SESSION['nivel'] == "User") { ?>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                Excel
                            </a>
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                <a class="dropdown-item" href="excel/planilha.php">Download planilha</a>

                            </ul>
                        </li>
                    <?php } ?>

                    <?php if ($_SESSION['nivel'] == "Administrativo" or $_SESSION['nivel'] == "User" or $_SESSION['nivel'] == "Tecnico") { ?>
                        <li class="nav-item dropdown">
                    ...
                    <?php if ($_SESSION['nivel'] == "Administrativo" or $_SESSION['nivel'] == "Tecnico") { ?>
                        <li class="nav-item dropdown">
                            <a class="nav-link" href="../patrimonios/manutencao">Manutenções</a>
                        </li>
                    <?php } ?>
                    ...
                    <?php if ($_SESSION['nivel'] == "Administrativo" or $_SESSION['nivel'] == "Tecnico") { ?>
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                ...
                                <a class="dropdown-item" href="usuarios/">Cadastro Usuários</a>
                                <a class="dropdown-item" href="equipamentos/">Cadastro Equipamentos</a>
                                <a class="dropdown-item" href="manutencoes/">Cadastro Manutenções</a>
                                <a class="dropdown-item" href="setores/">Cadastro Setores</a>
                                <a class="dropdown-item" href="unidades/">Cadastro Unidades</a>
